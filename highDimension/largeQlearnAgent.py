...
class largeQlearnAgent:
    ...
    def update_q_value(self, last_state_id, action, next_state_id, reward, next_map):
        ...
        self.q_matrix[rot_90_state_id][rotate_action] += self.alpha * (reward + self.discount_factor * max_value
        ...
        # self.q_matrix[rot_180_state_id][rotate_action] += self.alpha * (reward + self.discount_factor * max_value
        ...
        # self.q_matrix[rot_270_state_id][rotate_action] += self.alpha * (reward + self.discount_factor * max_value
